...
public class StripeService {
	...
	public PaymentIntent createPaymentIntent(BigDecimal amount, String currency, String description)
		...
		PaymentIntentCreateParams params = PaymentIntentCreateParams.builder().setAmount(value).setCurrency(currency)
				.setDescription(description).setAutomaticPaymentMethods(
